...
if __name__ == '__main__':
    ...
    P.add_argument('--coco', default=os.environ.get('COCO_ROOT', 'data/coco'))
    ...
    P.add_argument('--exdark_root', default=os.environ.get('EXDARK_ROOT', 'data/exdark/ExDark'))
    P.add_argument('--exdark_train_json', default=os.environ.get('EXDARK_TRAIN', 'data/exdark/exdark_train.json'))
    P.add_argument('--exdark_test_json', default=os.environ.get('EXDARK_TEST', 'data/exdark/exdark_test.json'))
